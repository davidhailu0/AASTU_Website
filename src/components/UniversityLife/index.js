...
export default function UniversityLife(){
    ...
    <Typography color={'#666'}  sx={{paddingLeft:"15px",paddingTop:"15px",paddingRight:"30px",lineHeight:2,textAlign:'start'}}>For most of you, University life is your first
...
challenging.</Typography>
    <Typography color={'#666'}  sx={{paddingLeft:"15px",paddingTop:"15px",paddingRight:"30px",lineHeight:2,textAlign:'start'}}>Indeed, it is not easy to miss family comfort and
...
citizen.</Typography>
    <Box sx={{display:{xs:'grid',md:'flex'},width:'80%',textAlign:'center',pt:'50px',margin:'auto'}}>
        <Box sx={{flexBasis:'32%',borderRadius:'10px',mb:'30px',position:'relative',overflow:'hidden'}}>
