...
export default function UniversityLife(){
    ...
    return (<section id='University_Life'><Box className='route' sx={{background:'white',paddingLeft:"30px",py:'2rem',mb:{md:"300px",xs:"500px"}}}>
        <Typography variant='h3' sx={{paddingLeft:"15px",color:'black',mb:'2rem'}}>University Life</Typography>
    ...
    <Typography color={'#666'}  sx={{paddingLeft:"15px",paddingTop:"15px",paddingRight:"30px",lineHeight:2,textAlign:'justify'}}>For most of you, University life is your first
...
challenging.</Typography>
    <Typography color={'#666'}  sx={{paddingLeft:"15px",paddingTop:"15px",paddingRight:"30px",lineHeight:2,textAlign:'justify'}}>Indeed, it is not easy to miss family comfort and
